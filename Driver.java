...
class Driver {
	public static void main(String[] args) {
		...
		System.out.println(move.getCard().getName()+"- "+move.getCard().getPower()+"\tCost: "+move.getCard().getAmount()+" "+move.getCard().getResource());
		
		move=game.turn(p2,p1);
		//will only be able to use Platoon, Tower, Knight, and Archer
		//Should use Tower
